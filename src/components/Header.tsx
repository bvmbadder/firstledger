...
const Header = () => {
  ...
  return (
    <div className="z-50 top-0 fixed w-full">
      ...
      <div className="relative backdrop-blur-md bg-[#14161a] flex justify-between">
        <div className="container mx-auto p-4 flex justify-between">
          ...
          <button
            className=" text-white border border-[#353a46] rounded h-fit p-2 px-3"
          ...
          {/*  */}
          <div
            className="navbar-burger js-burger block lg:hidden"
